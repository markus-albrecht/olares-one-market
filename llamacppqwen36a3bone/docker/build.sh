...
IMAGE="markus-albrecht/llamacpp-one:latest"
...
docker build \
    ...
    -t "$IMAGE" \
    -t "markus-albrecht/llamacpp-one:$LLAMA_CPP_REF" \
    .

echo ""
echo "Done! Images:"
echo "  $IMAGE"
echo "  markus-albrecht/llamacpp-one:$LLAMA_CPP_REF"
echo ""
echo "Push with:"
echo "  docker push $IMAGE"
echo "  docker push markus-albrecht/llamacpp-one:$LLAMA_CPP_REF"
echo ""
echo "Benchmark with:"
echo "  docker run --gpus all --rm markus-albrecht/llamacpp-one:$LLAMA_CPP_REF \\"
